...
import imitate.project.activity.MainBean;
import imitate.project.activity.MainBean2;
import imitate.project.base.mvp.BaseModel;
import imitate.project.bean.Bean1;
import imitate.project.bean.Bean2;
import imitate.project.bean.Bean3;
...
public interface ApiServer {
     ...
     */
    @POST("api/Activity/get_activities?")
    Observable<imitate.project.api.mvp.BaseModel<List<Bean1>, Bean2, List<Bean3>>> getMain2Demo(
    ...
    @FormUrlEncoded
    @POST("api/Activity/get_activities?")
    Observable<imitate.project.api.mvp.BaseModel<List<Bean1>, Bean2, List<Bean3>>> getMain3Demo(
